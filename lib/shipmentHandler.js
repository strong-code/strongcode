...
module.exports = {
  ...
  async createShipment(shipment) {
    ...
    if (exists) {
      ...
      return {s: 304, msg: `Shipment entry for ${shipment.tracking_number} already exists`}
    } else {
      await db.none(
    ...
    return {s: 200, msg: `Created entry for shipment ${shipment.tracking_number} (${shipment.carrier})`}
  },
